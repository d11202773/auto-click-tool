...
echo "1. ⚡ Simple APK Build (RECOMMENDED): https://github.com/d11202773/auto-click-tool/actions/workflows/simple-build.yml"
echo "2. 🔧 Main Build APK: https://github.com/d11202773/auto-click-tool/actions/workflows/build-apk.yml"
echo "3. 🐛 Debug Build: https://github.com/d11202773/auto-click-tool/actions/workflows/debug-build.yml"
echo ""

echo "📥 To get APK (if build successful):"
echo "1. Go to: https://github.com/d11202773/auto-click-tool/actions"
echo "2. Look for ✅ 'Simple APK Build' workflow (newest)"
echo "3. Click on successful run"
echo "4. Scroll down to 'Artifacts' section"
echo "5. Download 'auto-click-tool-apk'"
echo "6. Extract ZIP file to get APK"
echo ""
